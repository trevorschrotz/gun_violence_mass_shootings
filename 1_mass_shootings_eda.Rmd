...
Guns. Gun violence. Gun rights.  These are highly contentious and controversial issues that come with a host of prior tuning effects on individual opinions and beliefs.  What follows is a scientific analysis of mass shooting phenomena in the US.
...
An open and scientific mind was applied to data to produce information about the aforementioned phenomena both as a learning experience for the author and an informative experience for the public.

## Overview

Gun violence is a pervasive issue in American culture.  This analysis focuses on mass shootings in particular, and it does not include all types of US gun-related incidents.  A mass shooting is defined by the Federal Bureau of Investigation as a shooting in which four or more people are injured or killed not including the perpatrator(s) of the shooting.  The source of these data is the Gun Violence Archive, and the original sources of the shootings are news media reports and law enforcement reports.

The entire project is in four sections.  This first one is exploratory data analysis to gather an understanding of the data.  The second part is abour mapping mass shootings.  The third is about time series analysis, and the fourth is about machine learning.
...
### Chi-Squared Test - Weekday vs Month
...
Per capita, Washington, D.C. experiences the most mass shootings, injuries, and deaths.  This means that on a per person basis, you are more likely to experience a mass shooting in D.C., in fact, you are three times more likely than the next closest state which is Delaware in 2021.  

D.C. is extraordinarily higher, not in total volume, but in the number of mass shootings per person in the D.C. population.  
