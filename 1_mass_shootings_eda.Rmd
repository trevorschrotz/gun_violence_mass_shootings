...
rs_driver_object <- rsDriver(browser = "chrome", 
                             ...
                             verbose = FALSE, 
                             port = free_port(), 
                             extraCapabilities = list("--disable-blink-features=AutomationControlled"))

remDr <- rs_driver_object$client

# remDr$open() # opens a chrome browser / keep it open

remDr$navigate(url = "https://www.gunviolencearchive.org/incident/225830")
