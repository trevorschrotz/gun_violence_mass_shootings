...
This is the final step in the modeling process where we fit the most accurate models to the data including the data that we held back.  The line represents the expected value or average of the forecast, and the gray area represents the 95% confidence intervals around the prediction.  Obviously, no forecast will be absolutely correct, so the confidence intervals give us a reasonable expectation around where the true value will appear in the future.
