...
group_function <- function(df, ...) {
    ...
    output <- df %>% 
        ...
        summarize(n_incidents = n(),
                  n_deaths = sum(number_victims_killed + number_subjects_suspects_killed, na.rm = T),
                  n_injuries = sum(number_victims_injured + number_subjects_suspects_injured, na.rm = T),
                  .groups = "drop")
...
top_cities <- ms_tbl %>% 
    ...
    summarize(number_incidents = n(),
               number_killed = sum(number_victims_killed + number_subjects_suspects_killed),
              number_injured = sum(number_victims_injured + number_subjects_suspects_injured),
              .groups = "drop") %>% 
